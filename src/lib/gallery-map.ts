import type { GalleryProject } from "../types/gallery.js";
...
const getVariantStoragePaths = (storagePath: string) => {
...
const toPublicUrl = (currentUrl: string, currentPath: string, targetPath: string) => {
...
export const mapProjectRows = (rows: ProjectRow[]): GalleryProject[] =>
    rows.map((project) => {
